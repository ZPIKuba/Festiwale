...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="mySlides">
            ...
            <img src="res/galeria/choirOne.jpg" style="width:100%">
        </div>

        <div class="mySlides">
            <div class="numbertext">2 / 9</div>
            <img src="res/galeria/choirTwo.jpg" style="width:100%">
        </div>

        <div class="mySlides">
            <div class="numbertext">3 / 9</div>
            <img src="res/galeria/choirThree.jpg" style="width:100%">
        </div>

        <div class="mySlides">
            <div class="numbertext">4 / 9</div>
            <img src="res/galeria/choirFour.jpg" style="width:100%">
        </div>
        <div class="mySlides">
            <div class="numbertext">5 / 9</div>
            <img src="res/galeria/choirFive.jpg" style="width:100%">
        </div>
        <div class="mySlides">
            <div class="numbertext">6 / 9</div>
            <img src="res/galeria/choirSix.jpg" style="width:100%">
        </div>
        <div class="mySlides">
            <div class="numbertext">7 / 9</div>
            <img src="res/galeria/choirSeven.jpg" style="width:100%">
        </div>
        <div class="mySlides">
            <div class="numbertext">8 / 9</div>
            <img src="res/galeria/choirEight.jpg" style="width:100%">
        </div>
        <div class="mySlides">
            <div class="numbertext">9 / 9</div>
            <img src="res/galeria/choirNine.jpg" style="width:100%">
        </div>
