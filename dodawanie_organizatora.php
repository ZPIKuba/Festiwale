...
<form method="post" action="add_organizator.php">
    ...
    <p><label>Numer telefonu: <input id = "telefon" name = "telefon" type = "tel" pattern="[0-9]{9,}" size = "15" placeholder = "Telefon"></label></p>
    <p><label>Adres: <input id = "adres" name = "adres" type = "text" size = "100" placeholder = "Adres"></label></p>
